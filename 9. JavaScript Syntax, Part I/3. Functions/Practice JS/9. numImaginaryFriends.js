...
Write a function, numImaginaryFriends(), that takes in the total number of friends a person has and returns the number
of imaginary friends they have.

Since friends can only come in whole numbers, be sure to round your result up to the nearest whole number before
returning it.
...
const numImaginaryFriends =(numFriends)=>{
    const multiplier = 25/100;
    return Math.ceil(numFriends*multiplier);
}
