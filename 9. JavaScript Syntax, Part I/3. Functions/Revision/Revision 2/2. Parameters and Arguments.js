...
and use the inputs to perform a task. When declaring a function, we can specify its parameters.
...
placeholders for information that will be passed to the function when it is called.
    ...
    and inside the function body, they act just like regular variables. width and height act as placeholders
...
Notice that the order in which arguments are passed and assigned follows the order that the parameters
are declared.

    JavaScript syntax for invoking a function with arguments as variables
The variables rectWidth and rectHeight are initialized with the values for the height and width of a rectangle
