...
Even though the function is saved to a variable with a name, the function itself does not have a name; it is an anonymous function. It is still possible to name the function itself though and it may be beneficial for debugging purposes:
