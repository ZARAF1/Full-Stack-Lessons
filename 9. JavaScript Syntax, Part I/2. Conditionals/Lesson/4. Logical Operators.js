...
stoplight === 'green' && bypassers === 0 ? console.log('go man go') : console.log('stop man stop')


/*logical OR ( || )*/
// only one condition should evaluate to true for the entire condition to evaluate to trye
...
stoplight === "red" || bypassers >= 1 ? console.log("stop man bas") : console.log("go man nikalein")
