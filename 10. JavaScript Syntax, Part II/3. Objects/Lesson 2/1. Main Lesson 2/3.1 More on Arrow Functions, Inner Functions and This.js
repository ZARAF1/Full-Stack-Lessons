...
const mortal = {
    ...
    introduction: function () {
        ...
        return createIntroduction.call(this); // also works with apply
    }
}

console.log(mortal.introduction());
...
anthropoid.introduction();
// "Hello, my name is Stacy Student and my phone number is 0400123456789!"
//Functions declared using the function keyword need to be explicitly bound by using bind if that is something the
// developer desires, however arrow functions are automatically bound to the context of the outer function.
// What this means in practice is that the example below works equal to the example above:
