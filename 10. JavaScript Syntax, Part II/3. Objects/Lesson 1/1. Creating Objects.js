...
function Animal(type, first, last, age, eye) {
  this.type = type;
  this.firstName = first;
  this.lastName = last;
  this.age = age;
...
// function expressions do work
const Bird = function (type, first, last, age, eye) {
  this.type = type;
  this.firstName = first;
  this.lastName = last;
  this.age = age;
...
// Create bird object
const birdie = new Bird('lab', 'Bru', 'soe', 2, 'blue');
console.log(birdie);
