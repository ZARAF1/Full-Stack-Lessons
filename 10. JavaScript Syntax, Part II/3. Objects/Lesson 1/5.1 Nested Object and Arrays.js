let spaceship = {
    ...
    crew: {
        ...
        other: [{
            mechanic: {
                name: 'Ali', degree: 'Mechanical Engineering', message() {
                    return `I fix, even your parts`
                }
            }
        },
            {
                driver: {
                    name: 'Lion', degree: 'Aeronautical Engineering', message() {
                        return `Buckle up`
                    }
                }
            }]
...
console.log(spaceship.flightPath[0].planet + " in " + spaceship["flightPath"][0].month)