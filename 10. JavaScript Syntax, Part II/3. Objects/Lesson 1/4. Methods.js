let spaceShip = {
  ...
  // method 2: functionname: ()=>{} // anonymous function using arrow function this keyword wont work
  salutation: () => {
    // type 1 to create a method
    console.log("bye bye");
  },
  // method 3: functionname: function (){} // anonymous function
  printCrewNum: function () {
    // type 2 to create a method
    return this.crewNum;
  },
  // method 4 using arrow function: functionname:()=>{} //this keyword wont work in it
  hasTurboEngine: () => console.log(true),

  addPassengers: function (numOfPassengers) {
    // type 3 to create a method
  ...
  shipSummary() {
    console.log(
      `Welcome to ${this.name}. I am ${this.determineAge()} years old. I have ${
        this["turboEngine"] ? "A" : "No"
      } turbo engines`
    );
  },
  /*********
