...
const areaFunction=require('./shape-area.js')
...
const areaOfCircle = areaFunction.circleArea(radius);

const areaOfSquare = areaFunction.squareArea(sideLength);

console.log(areaOfCircle)
console.log(areaOfSquare)

// to check all properties imported to areaFunction object
