...
is that they allow the caller to speicfy the context manually without a need for the function to be a method
...
console.log(introduction.call(secondPerson))